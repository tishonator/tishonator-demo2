...
jQuery( document ).ready(function() {
  ...
  if (jQuery(".main-menu__home-three").find(".main-menu__list").length) {
    let dropdownAnchor = jQuery(
...
jQuery(document).ready(function() {
                jQuery(".project-one__carousel").owlCarousel({
                    "loop": true,
                    "autoplay": false,
                    "margin": 30,
                    "nav": false,
...
jQuery(document).ready(function(){
                    jQuery(".testimonial-one__carousel").owlCarousel({
                        loop: true,
                        autoplay: true,
                        margin: 30,
                        nav: false,
...
//t assets/vendors/jquery-appear/jquery.appear.min.js
