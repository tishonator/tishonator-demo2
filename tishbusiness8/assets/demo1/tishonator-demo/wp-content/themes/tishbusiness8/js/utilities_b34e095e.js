...
(function (root, factory) {
  ...
  Lightbox.prototype.enableKeyboardNav = function() {
    $(document).bind('keyup.keyboard', this.keyboardAction.bind(this));
  };
...
document.addEventListener('DOMContentLoaded', function() {
    var imageLinks = document.querySelectorAll("a[href$='.jpg']:not(.glightbox), a[href$='.png']:not(.glightbox), a[href$='.jpeg']:not(.glightbox), a[href$='.gif']:not(.glightbox), a[href$='.webp']:not(.glightbox)");
