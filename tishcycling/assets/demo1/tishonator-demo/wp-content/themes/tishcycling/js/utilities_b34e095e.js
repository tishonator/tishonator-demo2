...
document.addEventListener("DOMContentLoaded", function () {
  const productNamesMap = {
    "Product 1": "BMC URS AL TWO",
    "Product 2": "Specialized EPIC",
    "Product 3": "Trek DOMANE SL 6",
    "Product 4": "Giant TCR ADVANCED",
    "Product 5": "BMC ROADMACHINE X",
    "Product 6": "BMC FOURSTROKE LT",
    "Product 7": "Bianchi SPRINT - 105",
    "Product 8": "BMC ROADMACHINE 01"
  };
    ...
    jQuery(document).ready(function () {
        ...
        jQuery('.navbar-nav .dropdown > a').click(function (e) {
            if (jQuery(window).width() < 992) {
                ...
                jQuery(this).next('.dropdown-menu').slideToggle(); // Toggle the submenu
            }
        });
    });
});