...
//t https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.js
/**
 * Swiper 11.2.6
...
ready(function(){
    ...
    window.addEventListener('scroll', function() {
      if(window.scrollY > 220) scrollBtn.style.display = 'flex';
...
document.addEventListener("DOMContentLoaded", function () {
  const productNamesMap = {
    "Product 1": "Alpine Explorer Tent",
    "Product 2": "Forest Haven Dome",
    "Product 3": "Summit Ridge Shelter",
    "Product 4": "Trailblazer 2-Person Tent",
    "Product 5": "Cascade Creek Cabin",
    "Product 6": "Pinewood Family Tent",
    "Product 7": "Glacier Peak Shelter",
    "Product 8": "Wildwood Solo Tent"
  };
