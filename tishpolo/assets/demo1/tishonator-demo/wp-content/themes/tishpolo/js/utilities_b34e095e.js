...
(function ($) {
  ...
  $('#tp-main-menu-content > div > ul').unwrap();

  $('#tp-main-menu-content li').each(function(){
    if ($(this).find('> ul').length > 0) {
      $(this).addClass('has-dropdown');
    }
  });

  $('#tp-main-menu-content ul ul').addClass('tp-submenu');

  $('#tp-main-menu-content').css('display', 'block');
