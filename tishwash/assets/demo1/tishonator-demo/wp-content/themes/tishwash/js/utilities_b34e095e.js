...
document.addEventListener("DOMContentLoaded", function () {
  const productNamesMap = {
    "Product 1": "ShinePro Wash Bucket Kit",
    "Product 2": "FoamStorm Spray Cannon",
    "Product 3": "TireBrite Gel Cleaner",
    "Product 4": "CrystalView Glass Spray",
    "Product 5": "GlossMax Wax Finish Kit",
    "Product 6": "WheelShine Detailing Set",
    "Product 7": "InteriorGuard Protectant",
...
ready(function(){
    ...
    jQuery('article h1, article h2, article h3, article h4').removeClass('text-center');
